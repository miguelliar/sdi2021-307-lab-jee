...
public class PO_NavView  extends PO_View{
	 ...
	 * @paramcriterio: "id" or "class" or "text" or "@attribute" or "free". Si el valor de 
	...
	public static void clickOption(WebDriver driver, String textOption, String criterio, String textoDestino) {
		//CLickamos en la opción de registro y esperamos a que se cargue el enlacede Registro.
